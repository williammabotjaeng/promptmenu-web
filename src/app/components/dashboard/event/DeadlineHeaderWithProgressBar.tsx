...
const DeadlineHeaderWithProgressBar: React.FC<HeaderWithProgressBarProps> = ({ progressValue }) => {
  return (
    <Box sx={{ marginBottom: 4, mt: 4, width: '60%', position: 'relative' }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', marginTop: 1 }}>
        ...
        <Typography variant="body2" sx={{ color: '#977342', textAlign: 'right' }}>Add a Role</Typography>
        <Typography variant="body2" sx={{ color: '#977342', textAlign: 'right' }}>Application Deadline</Typography>
      </Box>
      <Link href="/dashboard">
