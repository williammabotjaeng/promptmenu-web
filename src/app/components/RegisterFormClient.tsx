...
const features = [
  {
    text: "Gain access to top-tier talent for your projects",
    alt: "Exclusive talent access icon",
  },
  {
  ...
  {
    text: "Explore global talents from around the world",
    alt: "Global opportunities icon",
  },
];

export const RegisterFormClient: React.FC = () => {
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            <Typography variant="body1" sx={{ color: "white", mb: 2 }}>
              Connect with top talent, casting directors, and{" "}
              <span style={{ display: "block" }}>
                agencies across the Middle East
              </span>
            </Typography>
