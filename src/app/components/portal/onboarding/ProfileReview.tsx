...
const ProfileReview = ({ talentData, personalInfo, physicalAttr }) => {
  return (
    <Box>
      ...
      <Grid container spacing={2} mt={2}>
        ...
        <Grid item xs={12} sm={6}>
          ...
          <Typography style={{ color: 'black' }}>Height: {physicalAttr.height || 'N/A'}</Typography>
          <Typography style={{ color: 'black' }}>Weight: {physicalAttr.weight || 'N/A'}</Typography>
          <Typography style={{ color: 'black' }}>Ethnicity: {physicalAttr.ethnicity || 'N/A'}</Typography>
        </Grid>
        <Grid item xs={12} sm={6}>
