...
export const CompanyProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [cookies, setCookie] = useCookies(['access', 'username', 'company_id', 'csrftoken']);
  ...
  return (
    <CompanyContext.Provider value={{ company: fetchCompanyMutation.data, signedUrls, fetchCompany, updateCompany }}>
      {children}
